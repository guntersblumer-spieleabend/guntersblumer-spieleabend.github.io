...
import { QrCodeEventPipe } from '../../shared/qr-code-event/qr-code-event.pipe';


@Component({
  selector: 'app-start',
  imports: [CommonModule, CompartementComponent, UtilTooltipModule, QRCodeComponent, QrCodeEventPipe],
